...
simFileNames = ["ndarrays_DoylePatientsHugeDataset_noNoise", "ndarrays_DoylePatientsHugeDataset_noNoise_noControl", "ndarrays_DoylePatientsHugeDataset.pt", "ndarrays_DoylePatientsHugeDataset_noControl.pt"]
...
for simFileName in simFileNames:
    ndarrays_DoylePatientsDataset = pickle.load(open(simFileName, "rb"))
